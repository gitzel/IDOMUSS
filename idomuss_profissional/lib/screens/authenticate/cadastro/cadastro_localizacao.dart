  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<Position>(
        stream: getPositionStream(desiredAccuracy: LocationAccuracy.best),
        builder: (context, snapshot) {
          ...
          return Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(left: paddingSmall, top: paddingExtraLarge, right: paddingSmall),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    BackButton(color: ColorSys.primary),
                    IconButton(
                      icon: Icon(Icons.help, color: ColorSys.primary,),
                      onPressed: (){},
                    )
                  ],
                ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(Icons.location_city, color: ColorSys.primary,),
                        ),
                        Flexible(child: Text(placemarks[0].subAdministrativeArea + ", " + placemarks[0].administrativeArea))
                      ],
                    ),
                  ),
                ),
                    ...
                    child: InkWell(
                      onDoubleTap: (){
                        ...
                        decoration: InputDecoration(
                          prefixIcon: Icon(Icons.confirmation_number, color: ColorSys.primary),
                          counterText: '',
