    ...
    return StreamBuilder<List<ServicoContratado>>(
      ...
      builder: (context, servico) {
        ...
        if(servico.data.isEmpty)
          return Center(
            child: Column(
              ...
              children: [
              Text("Infelizmente, não há atividade por agora!",
              ...
              Text("Avisaremos quando um serviço estiver próximo!",
              textAlign: TextAlign.center,
              style: TextStyle(
        ...
        return StreamBuilder<Cliente>(
          stream: DatabaseService().getCliente(servico.data.first.uidCliente),
          builder: (context, cliente) {
            ...
            return FutureBuilder<List<Placemark>>(
              future: placemarkFromCoordinates(servico.data.first.localizacao.latitude, servico.data.first.localizacao.longitude),
              builder: (context, localizacao) {
                ...
                return Padding(
                  padding: EdgeInsets.fromLTRB(
                      paddingSmall, paddingExtraLarge, paddingSmall, paddingLarge),
                  child: Container(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(left: 8.0),
                                        child: Text(
                                          formatDate(servico.data.first.data),
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontWeight: FontWeight.bold),
                                        ),
