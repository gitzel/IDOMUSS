...
class _AvaliarOrcamentoState extends State<AvaliarOrcamento> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<int>>(
        stream: DatabaseService(uid: widget.servicoContratado.uidProfissional)
            .limites,
          ...
          return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: paddingSmall),
                    child: AutoSizeText(
                      "Lembrando que sua cobrança varia de: ",
                      maxLines: 2,
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: fontSizeSubTitle * 0.75,
            ...
            bottomNavigationBar: FlatButton(
              ...
              child: Text(
                "Enviar orçamento",
                style:
                    TextStyle(color: Colors.white, fontSize: fontSizeRegular),
              ),
              color: ColorSys.primary,
              onPressed: orcamentoController.text.isEmpty
                  ? null
                  : () {
                      AwesomeDialog(
                        context: context,
                        ...
                        desc:
                            'Ao pressionar OK, seu cliente receberá o orçamento',
                        btnCancelOnPress: () {},
                        btnOkOnPress: () {
                          DatabaseService(
                                  uid: widget.servicoContratado.uidProfissional)
                              .sendOrcamento(widget.servicoContratado,
