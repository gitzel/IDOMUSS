        ...
        children: [
                Expanded(
                  child: StreamBuilder<List<ServicoContratado>>(
                      stream: DatabaseService(uid: user.uid).servicosPendentes(['Analisando']),
                            ...
                            Expanded(
                                  ...
                                  itemBuilder: (ctx, index) {
                                    return FutureBuilder<bool>(
                                      future: DatabaseService(uid:user.uid).temMensagem(['Solicitando'], servicosPendentes.data[index].uidCliente),
                                        ...
                                        return GestureDetector(
                                          onTap: () {
                                            Navigator.push(context,
                                              ...
                                              return AguardarClienteInfo(servicosPendentes.data[index]);
                                            }));
                                          },
                                          child: Stack(
                                            children: [
                                              ...
                                              !temMensagem.data && servicosPendentes.data[index].visualizadoProfissional
                                                  ? SizedBox.shrink()
                                                  : Positioned(
                                                      left: paddingSmall / 2,
                                                      top: 0,
