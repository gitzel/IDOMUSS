...
class ProfissionalItem extends StatefulWidget {
  ...
  Function test;
  ProfissionalItem(
      this.prof, this.favoritado, this.premium, this.height, this.test,
                    ...
                    children: <Widget>[
                      ...
                      IconButton(
                        icon: Icon(
                          ...
                          color:
                              widget.premium ? Colors.white : ColorSys.primary,
                        ),
                        onPressed: () {
                          AwesomeDialog(
                            context: context,
                            ...
                            title: !widget.favoritado
                                ? 'Adicionar aos favoritos'
                                : 'Remover dos favoritos',
                            desc: !widget.favoritado
                                ? 'Deseja adicionar este profissional a sua lista de favoritos?'
                                : 'Deseja retirar este profissional da sua lista de favoritos?',
                            btnCancelOnPress: () {},
