...
class _MenuComplementoState extends State<MenuComplemento> {
  ...
  TextEditingController _numeroController, _complementoController = new TextEditingController();
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: _numeroController.text.isEmpty
                            ...
                            : () {
                                ...
                                Navigator.pop(context, [widget.pos, widget.numero, _complementoController.text??""]);
                              },
                      ),
                    )),
              ],
