  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<DateTime>>(
        stream: DatabaseService(uid: user.uid).horarioDisponivel(widget.uidProf, horaSelecionada),
        builder: (context, snapshot) {
          ...
          child: SingleChildScrollView(
            physics: NeverScrollableScrollPhysics(),
              ...
              children: <Widget>[
                Container(
                  height: MediaQuery.of(context).size.height -kToolbarHeight - paddingScreen.top,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Image.asset("assets/geral/accept_service.png")),
                        Expanded(
                            child: Column(
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      ...
                                      children: [
                                        ...
                                        Text(DataToString()),
                                        Icon(Icons.arrow_drop_down, color: ColorSys.primary,),
                                      ],
                                    ),
                                  ),
                                  GestureDetector(
