...
class _ConfirmarServicoState extends State<ConfirmarServico> {
  ...
  String formatEndereco(String rua, String bairro, String numero, String complemento){
    return "${rua}, ${bairro}" + (numero.isNotEmpty? " - ${numero}" : "") + (complemento.isNotEmpty? ", ${complemento}" : "");
  }
  ...
  Future<List<Placemark>> getPosition() async {
    ...
    if(prefs.getDouble("latitude") == null){
      ...
      pos = Position(latitude: prefs.getDouble("latitude"), longitude: prefs.getDouble("longitude"));
    }
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(
                                                      child: ConfirmarPedidoTile("Quem?", widget.nomeProfissional),
                            
                          ),
                          Expanded(
                                                      child: ConfirmarPedidoTile("Quando?", formatDate(widget.servicoContrado.data)),
                            ),
                          
                          Expanded(
                                                      child:  ConfirmarPedidoTile("O quê?", widget.servicoContrado.descricao),
                            
                          ),
                          Expanded(
                                    child:                  ConfirmarPedidoTile("Onde?", formatEndereco(localizacao.data.first.street, localizacao.data.first.subLocality, widget.servicoContrado.numero, widget.servicoContrado.complemento)),
                          ),
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: RaisedButton(
                                  onPressed: (){
                                      if(widget.servicoContrado.numero.toString().isNotEmpty)
                                       AwesomeDialog(
                                              context: context,
                    ...
                    child: Container(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: _numeroController.text.isEmpty
                            ? null
                            : () {
                                  widget.servicoContrado.numero = _numeroController.text;
                                  widget.servicoContrado.complemento= _complementoController.text;
                                  AwesomeDialog(
                                              context: context,
                                              dialogType: DialogType.WARNING,
                                              animType: AnimType.TOPSLIDE,
