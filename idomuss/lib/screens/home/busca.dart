...
class _BuscaState extends State<Busca> {
  ...
  double _crossAxisSpacing = paddingMedium, _mainAxisSpacing = 12, _aspectRatio = 2;
  int _crossAxisCount = 2;

  @override
  Widget build(BuildContext context) {
    double size = MediaQuery.of(context).size.width;
    var width = (size - ((_crossAxisCount - 1) * _crossAxisSpacing)) / _crossAxisCount;
              ...
              child: RichText(
                text: new TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(
                        text: ' serviços', style: TextStyle(fontWeight: FontWeight.normal)),
                  ],
                ),
              ),
            ),
