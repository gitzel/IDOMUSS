        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Infelizmente você ainda não adicionou nenhum endereço!",
            ...
            child: RaisedButton(
                ...
                onPressed: () {
                  Navigator.pop(context, [
                    LatLng(list[index].location.latitude,
                        list[index].location.longitude),
                    list[index].numero
                  ]);
                },
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          AwesomeDialog(
                            ...
                            desc:
                                "Após removido, você terá que adicioná-lo novamente para desfazer a ação!",
                            btnCancelOnPress: () {},
                            btnOkOnPress: () {
                              DatabaseService(uid: uid)
                                  .removeUserAddress(list[index].location);
                            },
                          )..show();
                        },
                      ),
